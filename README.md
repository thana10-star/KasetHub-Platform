...
- `/app/farm-records` - M90 local farm records, activity/ledger edit flow, JSON/CSV export, guarded JSON restore, restore risk review, disabled sync consent prototype, farm cost dashboard, break-even estimate, archive/close guardrails, and recent timeline UI
