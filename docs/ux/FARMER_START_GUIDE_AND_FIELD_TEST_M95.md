...
M97 follow-up: `/app/help` adds examples for the first two actions:

- `ตัวอย่างชื่อแปลง: แปลงข้าวหลังบ้าน`
- `ตัวอย่างงาน: ใส่ปุ๋ยข้าว วันที่ 12 มิ.ย.`

M97.1 follow-up: `/app/help` now presents the default basic flow as three steps:
...
- เมนูล่างเข้าใจไหม
- ผู้ใช้เข้าใจ 3 ปุ่มหลักไหม
- ผู้ใช้เข้าใจไหมว่าต้องเริ่มจากเพิ่มแปลง
- ผู้ใช้เข้าใจรายรับ/รายจ่ายไหม
...
- มีส่วนไหนเยอะเกินไปไหม
- ผู้ใช้สับสนคำว่า รอบปลูก / จุดคุ้มทุน / ซิงก์ หรือไม่
- ผู้ใช้ยังต้องการ “บันทึกงานในฟาร์ม” อยู่หน้าแรกหรือไม่
