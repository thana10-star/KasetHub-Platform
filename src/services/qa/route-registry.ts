...
export const mvpRouteGroups: MvpRouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { route: '/app/help', label: 'Farmer start guide', milestone: 'M95/M96', notes: 'คู่มือเริ่มใช้ KasetHub แบบสั้นสำหรับเกษตรกร พร้อม flow 4 ขั้นตอน: เพิ่มแปลง บันทึกงานในฟาร์ม บันทึกรายรับรายจ่าย และบันทึกผลผลิต; no backend', manualCheckPath: '/app/help' },
      { route: '/app/field-test-feedback', label: 'Field-test feedback checklist', milestone: 'M95/M96', notes: 'เช็กลิสต์ภาคสนามแบบ static/local สำหรับสังเกตผู้ใช้จริง เพิ่มคำถาม first-use ของ Farm Records ไม่มี backend submit และเตือนห้ามใส่ข้อมูลส่วนตัว', manualCheckPath: '/app/field-test-feedback' },
      ...
      { route: '/app/my-farm', label: 'My Farm Hub', milestone: 'M02/M10/M34/M92-M96', notes: 'My Farm local hub with Farm Records cost, harvest/yield, backup/restore recovery, sync consent prototype status, compact Home entry point, dedicated bottom-nav slot, Profile settings data-control links, and compact first-use 4-step helper; no cloud sync', manualCheckPath: '/app/my-farm' },
      ...
      { route: '/app/farm-records', label: 'Farm Records first-use flow', milestone: 'M91/M92.1/M96', notes: 'farmer-facing local-first records UI with M96 first-use path, clearer empty states for plots/activity/finance/harvest, Thai-first form copy, harvest/yield records, local cost summaries, export/restore/recovery, disabled sync consent prototype; no cloud/GPS/AI/tax-accounting claims', manualCheckPath: '/app/farm-records' },
  ...
  },
  {
    ...
    routes: [
      ...
      { route: '/app/ai-text-endpoint-plan', label: 'AI text endpoint contract dry-run', milestone: 'M82', notes: 'endpoint URL, dry-run, network gating, server-only provider key boundary, and no-provider-call proof', manualCheckPath: '/app/ai-text-endpoint-plan' },
