...
export const mvpRouteGroups: MvpRouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      { route: '/app/youtube', label: 'YouTube hub', milestone: 'M03/M22.5/M124/M125/M126/M127/M128/M129/M130', notes: 'owner-curated fallback plus Cloudflare Function video library adapter; compact list UI links backend video IDs to the in-app official YouTube player, with no fake engagement stats', manualCheckPath: '/app/youtube' },
      { route: '/app/youtube/:videoId', label: 'YouTube video detail', milestone: 'M03/M124/M126/M127/M130', notes: 'official embedded YouTube player for backend-normalized videos; unknown IDs remain source-pending with no mock video fallback and keep the external YouTube/channel fallback', manualCheckPath: '/app/youtube/sample-video-id' },
