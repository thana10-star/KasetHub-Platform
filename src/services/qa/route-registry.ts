...
export const mvpRouteGroups: MvpRouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { route: '/app/my-farm', label: 'My Farm Hub', milestone: 'M02/M10/M34/M90', notes: 'My Farm local hub with Farm Records cost summary, backup/restore recovery, and sync consent prototype status; no cloud sync', manualCheckPath: '/app/my-farm' },
      ...
      { route: '/app/farm-records', label: 'Farm Records cost summary + break-even dashboard', milestone: 'M90', notes: 'farmer-facing local-first records UI with cost summary, category breakdown, break-even estimate, export/restore/recovery, disabled sync consent prototype, and no cloud/GPS/AI/tax-accounting claims', manualCheckPath: '/app/farm-records' },
