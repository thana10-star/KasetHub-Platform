...
export const mvpRouteGroups: MvpRouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      { route: '/app/youtube', label: 'YouTube hub', milestone: 'M03/M22.5/M124/M125/M126/M127/M128/M129/M130/M131/M132', notes: 'owner-curated fallback plus Cloudflare Function video library adapter; compact list UI has one video CTA, local loaded-video search, optional real backend view counts, and no fake engagement stats', manualCheckPath: '/app/youtube' },
      { route: '/app/youtube/:videoId', label: 'YouTube video detail', milestone: 'M03/M124/M126/M127/M130/M131/M132', notes: 'official embedded YouTube player for backend-normalized videos with optional real backend view counts; unknown IDs remain source-pending and the detail page keeps the external YouTube/channel fallback', manualCheckPath: '/app/youtube/sample-video-id' },
