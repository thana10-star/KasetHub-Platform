        ...
        notificationItem(
          {
            ...
            priority: 'normal',
            source: 'crop_watch',
            title: `ติดตามราคา ${watch.cropName}`,
            body: `ราคาอ้างอิงตัวอย่างล่าสุด ${watch.latestPriceLabel} ที่ ${watch.preferredMarketLabel}`,
            createdAt: watch.updatedAt,
            sourceLabel: notificationSourceLabels.crop_watch,
            demoLabel: 'ราคาอ้างอิง demo',
            ctaRoute: '/app/crop-watch',
            ctaLabel: 'ดูพืชที่ติดตาม',
            tags: ['crop-watch', watch.cropKey],
            metadata: {
      ...
      notificationItem(
        {
          ...
          body:
            preference.alertType === 'target_price' && preference.targetPrice
              ? `เป้าหมายตัวอย่าง ${preference.targetPrice.toLocaleString('th-TH')} บาท · ราคาอ้างอิงล่าสุด ${watch.latestPriceLabel}`
              : `ราคาอ้างอิงตัวอย่างล่าสุด ${watch.latestPriceLabel} · ${watch.preferredMarketLabel}`,
          createdAt: preference.updatedAt || watch.updatedAt,
          sourceLabel: notificationSourceLabels.crop_watch,
          demoLabel: 'ราคาอ้างอิง demo',
          ctaRoute: `/app/prices/${watch.priceId}`,
          ctaLabel: 'ดูรายละเอียดราคา',
          tags: ['crop-watch', watch.cropKey, preference.alertType],
          metadata: {
            cropKey: watch.cropKey,
  ...
  const fixtureFallbacks =
    watchedNotifications.length > 0
      ...
      : [
          notificationItem(
            {
              id: 'crop-price:rice-up-demo',
              type: 'crop_price_alert',
              priority: 'normal',
              source: 'crop_watch',
              title: 'ราคาข้าวหอมมะลิปรับขึ้นตัวอย่าง',
              body: 'ราคาอ้างอิงตัวอย่างข้าวหอมมะลิ 105 เพิ่มขึ้นจาก mock data ก่อนหน้า ยังไม่ใช่ราคาตลาดจริง',
              createdAt: '2026-05-23T07:10:00.000+07:00',
              sourceLabel: notificationSourceLabels.crop_watch,
              demoLabel: 'ราคาอ้างอิง demo',
              ctaRoute: '/app/prices/price-rice-jasmine-105-yasothon-demo',
              ctaLabel: 'ดูราคาอ้างอิง',
              tags: ['price', 'rice', 'demo'],
              metadata: {},
            },
            input,
          ),
          notificationItem(
            {
              id: 'crop-price:cassava-down-demo',
              type: 'crop_price_alert',
              priority: 'normal',
              source: 'crop_watch',
              title: 'ราคามันสำปะหลังลดลงตัวอย่าง',
              body: 'ราคาอ้างอิงตัวอย่างมันสำปะหลังสดลดลงจาก mock data ก่อนหน้า ยังไม่ใช่ราคาซื้อขายจริง',
              createdAt: '2026-05-23T07:05:00.000+07:00',
              sourceLabel: notificationSourceLabels.crop_watch,
              demoLabel: 'ราคาอ้างอิง demo',
              ctaRoute: '/app/prices/price-cassava-fresh-korat-demo',
              ctaLabel: 'ดูราคาอ้างอิง',
              tags: ['price', 'cassava', 'demo'],
              metadata: {},
            },
            input,
          ),
