          ...
          <Card className="border-rose-200 bg-white p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm leading-6 text-rose-900">
                  ตรวจ blocked release attempts, reviewer history, diff preview และ automation bypass policy
                </p>
              </div>
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm leading-6 text-sky-900">
                  กำหนด editor-only roles, release audit write contract และ rollback checklist ก่อนมี CMS จริง
                </p>
              </div>
